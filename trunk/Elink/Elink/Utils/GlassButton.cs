...
namespace Elink
{
    ...
    public partial class GlassButton : Button
    {
        ...
        /// </summary>
        /// <param name="e">An <see cref="T:System.EventArgs" /> that contains the event adv.</param>
        ...
        /// </summary>
        /// <param name="e">The <see cref="System.EventArgs" /> instance containing the event adv.</param>
        ...
        /// </summary>
        /// <param name="e">A <see cref="T:System.Windows.Forms.KeyEventArgs" /> that contains the event adv.</param>
        ...
        /// </summary>
        /// <param name="e">A <see cref="T:System.Windows.Forms.MouseEventArgs" /> that contains the event adv.</param>
        ...
        /// </summary>
        /// <param name="e">A <see cref="T:System.Windows.Forms.PaintEventArgs" /> that contains the event adv.</param>
            ...
            Color innerBorderColor, float glowOpacity)
        {
            ...
            rect.Width--;
            rect.Height--;
            using (GraphicsPath bw = CreateRoundRectangle(rect, rect.Height/2))
            {
            ...
            #region " content "
            using (GraphicsPath bb = CreateRoundRectangle(rect, rect.Height/2))
            {
            ...
            {
                using (GraphicsPath clip = CreateRoundRectangle(rect, rect.Height / 2))
                {
                    //g.SetClip(clip, CombineMode.Intersect);
                    //using (GraphicsPath brad = CreateBottomRadialPath(rect))
                    using (GraphicsPath brad = CreateRoundRectangle(rect, rect.Height/2))
                    {
                        using (PathGradientBrush pgr = new PathGradientBrush(brad))
                        {
                            ...
                            //g.FillPath(pgr, brad);
                            g.FillPath(new SolidBrush(backColor), brad);
                        }
                    }
                    g.ResetClip();
                }
            ...
            {
                rect2.Height++;
                using (GraphicsPath bh = CreateTopRoundRectangle(rect2, rect.Height/2))
                {
                    rect2.Height++;
                    int opacity = 0x99;
                    if (pressed | !enabled)
                    ...
                    {
                        //g.FillPath(br, bh);
                        g.FillPath(new SolidBrush(backColor), bh);
                    }
                }
                rect2.Height -= 2;
            }
